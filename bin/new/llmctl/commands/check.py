#!/usr/bin/env python3
"""Check command - Environment validation (replaces check_setup.py)."""
...
def check_config_files() -> List[Tuple[str, bool, str]]:
    ...
    for filename in files:
        ...
        try:
            ...
            results.append((filename, False, "pyyaml not installed"))
        except Exception as e:
...
def run_all_checks() -> int:
    ...
    if all_passed:
        ...
        print("\nYou can now run:")
        print("  llmctl proxy start    # Start the LiteLLM proxy")
        print("  llmctl launch         # Launch a model directly")
        return 0
    else:
